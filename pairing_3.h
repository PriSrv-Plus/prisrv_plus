...
public:
    ...
    Big Zpinverse(Big &x);
    Big Zpadd_mod(Big &a, Big &b);
    Big Zpmulti_mod(Big &a, Big &b);
    Big Zpsub_mod(Big &a, Big &b);
    Big Zpinverse_mod(Big &x);
    //
	...
	void random(Big&);
    void random_ord(Big&w);
    void random_mod(Big& w);
	void rankey(Big&);
	void random(G1&);
	void random(G2&);
